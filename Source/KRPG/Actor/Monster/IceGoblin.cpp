...
AIceGoblin::AIceGoblin()
{
	type = ECreatureMonster::IceGoblin;

	GetCapsuleComponent()->SetCapsuleHalfHeight(65.f);
	GetCapsuleComponent()->SetCapsuleRadius(34.f);

	ConstructorHelpers::FObjectFinder<USkeletalMesh> cMesh = ConstructorHelpers::FObjectFinder<USkeletalMesh>(TEXT("/Script/Engine.SkeletalMesh'/Game/Assets/Goblin/Mesh/Goblin_Base/SK_Goblin_ice.SK_Goblin_ice'"));
	if (cMesh.Succeeded())
	{
...
bool AIceGoblin::InitStat(ECreatureMonster _InitType)
{
...
void AIceGoblin::InitAIController()
{
	Super::InitAIController();
}

void AIceGoblin::InitPawnSensing()
{
...
void AIceGoblin::AllocatedMachine()
{
...
FVector AIceGoblin::GetCombatSocketLocation()
{
	check(Weapon);
